...
import { Settings, ChevronRight, Key, Cpu, Plus, GripVertical, Trash2, X, Save } from 'lucide-vue-next'
...
const sections = [
  ...
  // { id: 'shortcuts', title: 'Atajos', description: 'Personaliza los atajos de teclado', icon: Keyboard },
]
